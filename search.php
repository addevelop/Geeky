...
<section class="container_product row">
    <?php
    $sql = "SELECT *, AVG(note1_opinion) as 'note1_opinion' FROM products prd INNER JOIN opinion opi on prd.ID_prd = opi.ID_prd WHERE prd.activate_prd = 1  GROUP BY prd.ID_prd";
